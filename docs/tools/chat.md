# Brainstorm Tool - General Development Chat & Collaborative Thinking

**Your thinking partner - bounce ideas, get second opinions, brainstorm collaboratively**

The `brainstorm` tool is your collaborative thinking partner for development conversations. It's designed to help you brainstorm, validate ideas, get second opinions, and explore alternatives in a conversational format.
...
and then brainstorm with gemini pro and continue discussing pros and cons to come to a final conclusion. I need a one
...
* We ask Claude code to pick one of two frameworks, then `brainstorm` with `gemini` to make a final decision
...
- **Image support**: Include screenshots, diagrams, UI mockups for visual analysis: `"Brainstorm with gemini about this error dialog screenshot to understand the user experience issue"`
...
When using advanced reasoning models like **GPT-5 Pro** or **Gemini 2.5 Pro**, the brainstorm tool can generate complete, production-ready code implementations in a structured format.

### How It Works

1. You ask your AI agent to implement a complex new feature using `brainstorm` with a higher-reasoning model such as **GPT-5 Pro** or **Gemini 2.5 Pro**
...
```
brainstorm with gpt-5-pro and ask it to make me a standalone, classic version of the
...
```
"Brainstorm with zen about the best approach for user authentication in my React app"
```
...
```
"Brainstorm with pro about microservices vs monolith architecture for my project, consider scalability and team size"
```

**File Context Analysis:**
```
"Use gemini to brainstorm about the current authentication implementation in auth.py and suggest improvements"
```

**Visual Analysis:**
```
"Brainstorm with gemini about this UI mockup screenshot - is the user flow intuitive?"
```
...
## When to Use Brainstorm vs Other Tools

- **Use `brainstorm`** for: Open-ended discussions, brainstorming, getting second opinions, technology comparisons
