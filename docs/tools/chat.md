...
- **Structured code generation**: When using gpt-5.6-terra Pro or Gemini 2.5 Pro, get complete, production-ready implementations saved to `zen_generated.code` for your CLI to review and apply
...
When using advanced reasoning models like **gpt-5.6-terra Pro** or **Gemini 2.5 Pro**, the chat tool can generate complete, production-ready code implementations in a structured format.

### How It Works

1. You ask your AI agent to implement a complex new feature using `chat` with a higher-reasoning model such as **gpt-5.6-terra Pro** or **Gemini 2.5 Pro**
...
```
chat with gpt-5.6-terra-pro and ask it to make me a standalone, classic version of the
