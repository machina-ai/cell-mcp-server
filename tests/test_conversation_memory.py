...
class TestConversationFlow:
    ...
    def test_conversation_with_files_and_context_preservation(self, mock_storage):
        ...
        assert "--- Turn 1 (gemini-3.7-flash using analyze via google) ---" in history
        assert "--- Turn 2 (Agent) ---" in history
        assert "--- Turn 3 (gemini-3.7-flash using analyze via google) ---" in history
        ...
        turn_1_pos = history.find("--- Turn 1 (gemini-3.7-flash using analyze via google) ---")
        turn_2_pos = history.find("--- Turn 2 (Agent) ---")
        turn_3_pos = history.find("--- Turn 3 (gemini-3.7-flash using analyze via google) ---")
