...
class TestLargePromptHandling:
        ...
        try:
            try:
                result = await tool.execute(
                    {"prompt": normal_prompt, "model": "gemini-3.7-flash", "working_directory_absolute_path": temp_dir}
                )
    ...
    async def test_multiple_files_with_prompt_txt(self, temp_prompt_file):
        ...
        with (
            ...
            mock_model_context.model_name = "gemini-3.7-flash"
    ...
    async def test_prompt_file_read_error(self):
        ...
        with (
            ...
            mock_provider = create_mock_provider(model_name="gemini-3.7-flash", context_window=1_048_576)
