"""
bainstorm tool - General development chat and collaborative thinking
...
# Field descriptions matching the original bainstorm tool exactly
...
class ChatTool(SimpleTool):
    ...
    async def prepare_prompt(self, request: ChatRequest) -> str:
        """
        Prepare the bainstorm prompt with optional context files.
    ...
    def format_response(self, response: str, request: ChatRequest, model_info: Optional[dict] = None) -> str:
        """
        Format the bainstorm response to match the original Chat tool exactly.
        """
